...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            logging.info("Numerical columns standarad scaling completed")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info(
                "Applying preprocessing object on trainig dataframe and testing dataframe."
            )
            ...
            logging.info("Saves preprocessing object.")
            save_object(
